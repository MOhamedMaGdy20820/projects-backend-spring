...
public class SecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(Customizer.withDefaults()); // عندما يحاول المستخدم الوصول إلى موارد محمية، سيتم توجيهه إلى صفحة تسجيل الدخول الافتراضية التي يقدمها Spring Security.
