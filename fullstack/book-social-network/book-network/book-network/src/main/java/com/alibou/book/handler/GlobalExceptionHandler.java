...
public class GlobalExceptionHandler {
    ...
    // هذه التعليمة تُخبر Spring بأن هذه الدالة هي معالج لاستثناءات من النوع LockedException. عندما يحدث هذا الاستثناء في أي مكان في التطبيق، سيتم استدعاء هذه الدالة
    @ExceptionHandler(LockedException.class)
    public ResponseEntity<ExceptionResponse> handleException(LockedException exp) {

        return ResponseEntity
                .status(UNAUTHORIZED) // يتم إرجاع حالة HTTP 401 Unauthorized للدلالة على أن المستخدم ليس لديه صلاحيات للوصول (يمكن أن تكون LOCKED أو FORBIDDEN أكثر ملاءمة في هذه الحالة).
                .body(
