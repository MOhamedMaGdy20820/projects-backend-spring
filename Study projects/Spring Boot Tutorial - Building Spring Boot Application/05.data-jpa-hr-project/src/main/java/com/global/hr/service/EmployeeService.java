...
//		orders.add(order2);
	...
	public List<EmployeeProjection> constFilter(String name ) {

		if (name.isEmpty() || name.isBlank() || name == null) {
			name = null;
		}
		return employeeRepo.constFilter(name);
	}

	public List<Employee> filterNative(String name) {
	...
	public Employee insert(Employee emp) {
		...
		// if the department exist we will update it
